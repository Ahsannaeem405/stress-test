        ...
        <div class="container">
            <div class="row">
                <div class="Innerdetail text-start">
                    ...
                    <p class="mt-3 red" style="background: #ff0000;">Stresstilstand: <strong> 68-96:</strong> Alvorlig stress <span class="float-end">Du er stresset og skal gøre noget ved det</span> </p>
