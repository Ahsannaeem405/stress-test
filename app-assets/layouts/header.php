...
<!--                <li class=" navigation-header"><span>pages</span></li>-->
                <li class=" nav-item"><a href="index.php"><i class="feather icon-monitor"></i><span class="menu-title" data-i18n="Profile">Dashboard</span></a></li>
                <li class=" nav-item"><a href="products.php"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Account Settings">Users</span></a></li>
                <li class=" nav-item"><a href="add-products.php"><i class="feather icon-help-circle"></i><span class="menu-title" data-i18n="FAQ">Test</span></a></li>
                <li class=" nav-item"><a href="settings.php"><i class="feather icon-settings"></i><span class="menu-title" data-i18n="Search">Settings</span></a></li>
